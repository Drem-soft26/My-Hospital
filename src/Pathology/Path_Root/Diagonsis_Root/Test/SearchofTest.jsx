...
export default function SearchofTest() {
    ...
    useEffect(() => {
        ...
        const savedReferers =
            JSON.parse(localStorage.getItem("referrersData") || "[]");
        ...
        <>
            <div className="h-[98vh] overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 p-3">
                ...
                <div className="w-full h-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
                    ...
                    {/* MAIN GRID */}
                    <div
                        className="grid gap-4 p-4 h-[calc(98vh-90px)]"
                        style={{
                            gridTemplateColumns:
                                "1fr 4fr 2fr"
                        }}
    ...
    <h2 className="text-xl font-bold col-span-2 self-center">
        Patient Information
    </h2>
        ...
        >
            {selectedPatient ? "Save" : "Edit"}
                            ...
                            <div className="mt-3">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <select
                                        className="p-3 border rounded-xl min-w-[180px]"
                                        onChange={(e) => {
                                    ...
                                    <button
                                        onClick={addTest}
                                        className="bg-blue-600 hover:bg-blue-700 text-white px-5 rounded-xl font-bold cursor-pointer"
                                    >
                                        Add
                                    </button>
                                </div>
                        ...
                        <div className="bg-white rounded-3xl shadow-xl border p-4 flex flex-col overflow-hidden">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-3 border font-bold bg-lime-100 text-3xl text-center rounded-xl"
                                        />
                                    </div>
                                    <div>

                                        <p className="mb-1 font-semibold text-xl text-center">
                                            Discount
                                        </p>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-3 border rounded-xl font-bold text-center text-2xl"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-2xl font-bold"
                                >
                                    🖨️ Print
                                </button>
                            </div>
            ...
            {message.show && (
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/40">
                    ...
                    <div
                        className={`px-8 py-5 rounded-2xl text-white text-lg font-semibold shadow-2xl ${
                            message.type ===
                            "error"
                                ? "bg-red-600"
                                : "bg-green-600"
